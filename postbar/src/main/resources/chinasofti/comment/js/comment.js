...
function showPostlist(post,user,register,postPraise,myUserUUID,myAdmin){
	...
	html+='<audio src="'+'/postbar'+post.postAudio+'" controls="controls" style="height:20px"></audio>&nbsp;|&nbsp;<a id="praisecNum" href="javascript:void(0);" onclick="praiseclick(\''+post.postUUID+'\',\''+pr+'\',\''+post.postAudio+'\')">赞：</a> '+postPraise.length;
...
function allCommentlist(allCommentlist,admin){
	...
	html+=		'<audio src="'+urlhead+allCommentlist[i].cmAudio+'" controls="controls" style="height:20px"></audio>&nbsp;|&nbsp;<a id="praisecNum" href="javascript:void(0);" onclick="hotsPraiseClick(\''+allCommentlist[i].postUUID+'\',\''+allCommentlist[i].cmUUID+'\')">赞：</a> '+allCommentlist[i].cmPrNum;
	html+=	'</div>';
	html+='</div>';
	html+='<hr>';
	}
...
html+=		'<audio src="'+urlhead+hotsCommentlist[i].cmAudio+'" controls="controls" style="height:20px"></audio>&nbsp;|&nbsp;<a id="praisecNum" href="javascript:void(0);" onclick="hotsPraiseClick(\''+hotsCommentlist[i].postUUID+'\',\''+hotsCommentlist[i].cmUUID+'\')">赞：</a> '+hotsCommentlist[i].cmPrNum;
html+=	'</div>';
html+='</div>';
html+='<hr>';
}
